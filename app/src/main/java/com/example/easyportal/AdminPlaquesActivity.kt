...
class AdminPlaquesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_super_admin_plaques) // même layout que pour le superadmin
            ...
            { response ->
                try {
                    if (response.getBoolean("success")) {
                        ...
                        Log.d("ADAPTER_DATA", "Utilisateurs (role=utilisateur) : ${usersMap.size}")
